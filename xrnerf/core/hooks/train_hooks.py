...
# @Last Modified time: 2022-04-28 13:35:40
...
class PassIterHook(Hook):
    """
    思路来自于--
        https://discuss.pytorch.org/t/pass-extra-arguments-to-getitem/100926/3
    ...
    def after_train_iter(self, runner):
        # print(dir(runner.data_loader.iter_loader))
...
class OccupationHook(Hook):
    """
        GPU source occupation hook
        GPU cards are fucking hard to queue recently
