...
work_dir = './work_dirs/nerfsv3/nerf_materials_base01/'  # noqa
...
train_pipeline = [
    ...
    dict(type='SelectRays', enable=True, sel_n=N_rand_per_sampler, precrop_iters=3000, precrop_frac=0.5), # 抽取N个射线
